...
namespace BlazorTestApp.Blazor.Server {
    public partial class BlazorTestAppBlazorApplication : BlazorApplication {
        public BlazorTestAppBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void BlazorTestAppBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
